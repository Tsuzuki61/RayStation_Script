...
def ok_button(sender, event):
    ...
    roi_doses_indice = plan.TreatmentCourse.TotalDose.GetDoseGridRoi(RoiName=roi_name).RoiVolumeDistribution.VoxelIndices
    doses = list(plan.TreatmentCourse.TotalDose.DoseValues.DoseData)
